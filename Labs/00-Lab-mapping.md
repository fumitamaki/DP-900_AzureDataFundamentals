...
| 04- Azure でデータ分析を調べる | Azure Synapse Analytics を使用して Azure のデータ分析を調べる | [dp900-04-synapse-lab.md](https://github.com/fumitamaki/DP-900_AzureDataFundamentals/blob/main/Labs/dp900-04-synapse-lab.md) |
| 04- Azure でデータ分析を調べる | Azure Stream Analytics を調べる                              | [dp900-05-stream-lab.md](https://github.com/fumitamaki/DP-900_AzureDataFundamentals/blob/main/Labs/dp900-05-stream-lab.md) |
